  ...
  return (
    <div className="px-6 pt-10 ">
      <div className="flex justify-between">
        <h1 className="text-lg sm:text-2xl font-bold text-white">Your Friends</h1>
        <div className="flex justify-center items-center cursor-pointer gap-2 bg-green-800 px-2 py-1 rounded-2xl border-1 border-white">
          <Users className="w-4 text-white " />
          <button className="text-xs text-white cursor-pointer">Friend Requests</button>
        </div>
      </div>
